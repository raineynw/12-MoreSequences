...
def run_test_draw_points_on_circle():
    ...
    window = rg.RoseWindow(400,400, 'Test 4: 80 purple dots on black circle')
    circle = rg.Circle(rg.Point(200.0,200.0),180)
...
def run_test_pizza():
    ...
    #Test 4
    title = 'PIZZA test 4:  14 slices, thicc (thickness=7) red lines.'
    window = rg.RoseWindow(500, 500, title)
    circle = rg.Circle(rg.Point(250, 250), 150)
    circle.outline_thickness = 3
    pizza(window, circle, 14, 'red', 7)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    # Test 34(on another window):
    title = ('FANCY POLYGON test 4:  18 lime red lines on white circle,'
             + ' hops = 7.')
    window = rg.RoseWindow(400, 400, title)

    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.fill_color = 'white'
    fancy_polygon(window, circle, 18, 7, 'red', 7)
    window.close_on_mouse_click()
